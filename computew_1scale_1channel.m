...
function W=computeW_multiscale_my_test(layer,image_x,sigma_xI,image_y,sigma_yI,wi,wj);
options.mode='multiscale_option';
options.mode2='my_test';
options.F1 =image_x/sigma_xI;%this is the x-directional flow
options.F2 =image_y/sigma_yI;%this is the y-directional flow
%keyboard; %this maybe an alternative place to vary cue combination
options.location=layer.location;
W = mex_affinity_option(wi,wj,options);
